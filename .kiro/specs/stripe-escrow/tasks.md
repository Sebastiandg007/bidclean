...
- [ ] 2. Backend — Database Schema & Migration
  - [ ] 2.1 Create the payments migration
...
- [ ] 3. Backend — Types, Constants, State Machines & Refund Policy
  - [ ] 3.1 Create payments types and enums
  ...
  - [ ] 3.2 Create payments constants with startup validation
  ...
  - [ ] 3.3 Implement the three pure state machines
  ...
  - [ ] 3.4 Implement the refund/reversal policy (pure)
  ...
  - [ ]* 3.5 Write unit tests for state machines and refund policy
...
- [ ] 4. Backend — Stripe Client Seam
  - [ ] 4.1 Implement StripeClient wrapper
  ...
  - [ ]* 4.2 Write unit tests for StripeClient (mocked SDK)
...
- [ ] 5. Backend — Repository & Sanitizer
  - [ ] 5.1 Implement payment event payload sanitizer
    ...
    - _Requirements: 5.4_
  - [ ] 5.2 Implement PaymentsRepository
  ...
  - [ ]* 5.3 Write unit tests for repository invariants
...
- [ ] 6. Checkpoint — Backend foundation compiles and unit tests pass
...
- [ ] 7. Backend — Connect Onboarding & Account Sync
  - [ ] 7.1 Implement ConnectOnboardingService
  ...
  - [ ] 7.2 Implement ConnectReconciliationService
  ...
  - [ ]* 7.3 Write unit tests for connect onboarding & reconciliation
...
- [ ] 8. Backend — Escrow Charge (on match)
  - [ ] 8.1 Implement EscrowChargeService and OfferMatchedListener
  ...
  - [ ]* 8.2 Write unit tests for escrow charge
...
- [ ] 9. Backend — Escrow Release (confirm / auto / deferred)
  - [ ] 9.1 Implement EscrowReleaseService
  ...
  - [ ] 9.2 Implement AutoReleaseWorker
  ...
  - [ ]* 9.3 Write unit tests for release + auto-release
...
- [ ] 10. Backend — Refunds, Reversal & Disputes
  - [ ] 10.1 Implement RefundService
  ...
  - [ ]* 10.3 Write unit tests for refunds, reversal and disputes
...
- [ ] 11. Backend — Controller, Webhooks & DTOs
  - [ ] 11.1 Implement PaymentsController
  ...
  - [ ] 11.2 Implement StripeWebhookController + DTOs
  ...
  - [ ]* 11.3 Write unit tests for controllers
...
- [ ] 12. Backend — Webhook Processor, Reconciliation & Module Wiring
  - [ ] 12.1 Implement StripeWebhookProcessor
  ...
  - [ ] 12.2 Implement PaymentReconciliationService
  ...
  - [ ]* 12.4 Write unit tests for processor & reconciliation
...
- [ ] 13. Checkpoint — Backend payment flows work end-to-end
  - Ensure all backend tests pass; ask the user if questions arise.

- [ ] 14. Mobile — Store, Types & API Client
  - [ ] 14.1 Create payments types and constants
  ...
  - [ ] 14.2 Implement payments API client
  ...
  - [ ] 14.3 Implement usePayments Zustand store
  ...
  - [ ]* 14.4 Write unit tests for usePayments
...
- [ ] 15. Mobile — Payment & Onboarding UI
  - [ ] 15.1 Implement HostPaymentMethodScreen
  ...
  - [ ] 15.2 Implement CleanerPayoutOnboardingScreen + banners
  ...
  - [ ] 15.3 Implement PaymentStatusScreen + components
...
- [ ] 17. Property-Based Tests (fast-check)
  ...
  - [ ]* 17.2 Property test: Breakdown Consistency
  ...
  - [ ]* 17.6 Property test: Payout Gate
  ...
  - [ ]* 17.11 Property test: Reconciliation Convergence
  ...
  - [ ]* 17.12 Property test: Lifecycle Orthogonality
...
- [ ] 18. Integration & Scenario Tests
  ...
  - [ ]* 18.7 Integration test: webhook dedup + DB constraints + reconciliation
    ...
    - _Requirements: 5.4, 5.11_
  - [ ]* 18.8 Integration test: charge failed to retry (new attempt)
