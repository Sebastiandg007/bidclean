...
- [-] 1. Create offers module structure in NestJS (module, controller, service, repository, types, constants, dto/, entities/, commission/, delivery/, discovery/, expansion/, notification/, contracts/, events/, state-machine/, guards/, __tests__/, README)
