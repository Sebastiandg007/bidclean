...
- [ ] 1. Types & configuration (pure core)
  - [ ] 1.1 Create ads domain types
  ...
  - [ ] 1.2 Create ads constants (EXPO_PUBLIC_* config)
  ...
  - [ ] 1.3 Add ad environment variables to `.env.example`
...
- [ ] 2. Personalization & attribution (pure)
  - [ ] 2.1 Implement platform-aware personalization
  ...
  - [ ] 2.2 Implement privacy-scoped attribution identity
  ...
  - [ ]* 2.3 Unit tests for personalization & attribution
...
- [ ] 3. Ad revenue tracker
  - [ ] 3.1 Implement AdRevenueTracker
  ...
  - [ ]* 3.2 Unit tests for AdRevenueTracker
...
- [ ] 4. Ad provider seam (interface + mock + AdMob + factory)
  - [ ] 4.1 Implement MockAdProvider
  ...
  - [ ] 4.3 Implement the provider factory
  ...
  - [ ]* 4.4 Unit tests for provider factory & mock
...
- [ ] 5. Checkpoint - pure core + provider seam compile and unit tests pass
...
- [ ] 6. Ads store & consent
  - [ ] 6.1 Implement useAds Zustand store
...
- [ ] 7. Slot lifecycle hook & AdBanner
  - [ ] 7.1 Implement useAdSlot hook
  ...
  - [ ] 7.2 Implement AdBanner component
  ...
  - [ ]* 7.3 Unit tests for useAdSlot & AdBanner
...
- [ ] 8. Radar integration (fill the AdSlot)
  - [ ] 8.1 Wire AdSlot to real ads
  ...
  - [ ] 8.2 Extend radar adSlot i18n (en + es)
...
- [ ] 9. Native SDK integration & test mocks
  - [ ] 9.1 Add the AdMob SDK + Expo config plugin
  ...
  - [ ] 9.2 Mock the native ad + UMP modules in Jest
...
- [ ] 10. Checkpoint - full ads UX integrated on mobile
...
- [ ] 11. Property-Based Tests (fast-check)
  - [ ]* 11.1 Property: Eligibility authority
  ...
  - [ ]* 11.2 Property: Consent correctness (platform-aware)
  ...
  - [ ]* 11.3 Property: No double counting / impression uniqueness
  ...
  - [ ]* 11.4 Property: Slot lifecycle idempotency
  ...
  - [ ]* 11.5 Property: Placement unchanged
...
- [ ] 12. Integration & Scenario Tests
  - [ ]* 12.1 Integration: free-tier Cleaner sees an ad, PRO/ad_free does not
  ...
  - [ ]* 12.2 Integration: paid impression -> AdRevenueTracker -> RevenueCat (mock)
  ...
  - [ ]* 12.3 Integration: no-fill and provider-init failure degrade gracefully
  ...
  - [ ]* 12.4 Integration: consent gates personalization, not eligibility
...
- [ ] 13. Final Checkpoint - all tests pass, CI-equivalent green
