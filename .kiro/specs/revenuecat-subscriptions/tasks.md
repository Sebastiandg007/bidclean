...
- [x] 1. Contract extension in commission-system (role-aware tier)
  - [x] 1.1 Extend the SUBSCRIPTION_TIER contract with getRoleTier
    ...
    - _Requirements: 1.7_
  - [x] 1.2 Switch CommissionRatesProvider to per-role resolution
...
- [x] 2. Environment configuration & constants
  - [x] 2.1 Add subscription environment variables to `.env.example`
  ...
  - [x] 2.2 Create subscriptions constants with startup validation
...
- [x] 3. Backend — Database Schema & Migrations
  - [x] 3.1 Create the subscriptions mirror migration
  ...
  - [x] 3.2 Create the subscription events ledger/outbox migration
...
- [x] 4. Backend — Types & Entities
  - [x] 4.1 Create subscriptions types
...
- [x] 5. Backend — Pure Core (mapper, sanitizer, signature)
  - [x] 5.1 Implement the RevenueCat event mapper (pure)
  ...
  - [x] 5.2 Implement the payload sanitizer (pure)
  ...
  - [x] 5.3 Implement the HMAC signature verifier (pure)
  ...
  - [x]* 5.4 Unit tests for mapper, sanitizer, signature
...
- [x] 6. Backend — Repository (mirror + ledger/outbox)
  - [x] 6.1 Implement SubscriptionsRepository
  ...
  - [x]* 6.2 Unit tests for repository invariants
...
- [x] 7. Backend — SUBSCRIPTION_TIER real implementation
  - [x] 7.1 Implement RealSubscriptionTierService
  ...
  - [x]* 7.2 Unit tests for tier resolution
...
- [x] 8. Backend — RevenueCat client seam
  - [x] 8.1 Implement RevenueCatClient
  ...
  - [x]* 8.2 Unit tests for RevenueCatClient (mocked fetch)
    - getSubscriber maps RC -> entitlement snapshot; deleteSubscriber handles 404; auth header attached
    - _Requirements: 4.1_

- [x] 9. Checkpoint — Backend core compiles and unit tests pass
...
- [x] 10. Backend — Webhook ingress + processing + recovery
  - [x] 10.1 Implement RevenueCatWebhookController (public, HMAC, outbox)
  ...
  - [x] 10.2 Implement RevenueCatWebhookProcessor (BullMQ)
  ...
  - [x] 10.3 Implement SubscriptionDispatchWorker (recovery)
  ...
  - [x]* 10.4 Unit tests for webhook controller + processor + recovery
...
- [x] 11. Backend — Reconciliation (converge + discover)
  - [x] 11.1 Implement SubscriptionReconciliationService
  ...
  - [x]* 11.2 Unit tests for reconciliation
...
- [x] 12. Backend — Client endpoint + module wiring (A)
  - [x] 12.1 Implement SubscriptionsService + GET /subscriptions/me (self-healing)
  ...
  - [x] 12.2 Wire SubscriptionsModule and re-wire CommissionModule
  ...
  - [x]* 12.3 Unit tests for controller + wiring
...
- [x] 13. Backend — Account deletion integration
  - [x] 13.1 Extend the deletion cascade with mirror cleanup
  ...
  - [x]* 13.2 Unit tests for deletion cleanup
    - mirror removed + ledger anonymized; no-RC-subscriber path graceful; idempotent re-run
    - _Requirements: 8.2, 8.3_

- [x] 14. Checkpoint — Backend subscription flow works end-to-end
...
- [x] 15. Mobile — SDK, store & API client
  - [x] 15.1 Add RevenueCat SDK + Paywalls UI and types/constants
  ...
  - [x] 15.2 Implement subscriptions API client
    - Create `subscriptions.api.ts`: typed `getMe()` -> `GET /subscriptions/me` via lazy `getApiClient()`
    - _Requirements: 7.1_
  - [x] 15.3 Implement useSubscription Zustand store
  ...
  - [x]* 15.4 Unit tests for useSubscription
...
- [x] 16. Mobile — Paywalls & gates
  - [x] 16.1 Implement PaywallScreen (Paywalls V2)
  ...
  - [x] 16.2 Wire ad_free + PRO badge to real entitlements
