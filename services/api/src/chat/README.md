...
> The remaining components (`chat.module.ts`, `chat.controller.ts`, `chat.service.ts`, DTOs) are landing incrementally per the `realtime-chat` spec tasks. Update this table as each file is added.
